...
var file_discount_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x3e, 0x0a, 0x04, 0x49, 0x6e,
	...
	0x09, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x64, 0x22, 0x50, 0x0a, 0x08, 0x44, 0x69,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x49, 0x6e, 0x43, 0x65, 0x6e, 0x74, 0x73, 0x32, 0x4c, 0x0a, 0x0f,
	0x44, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x39, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x44, 0x69, 0x73, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x0e, 0x2e, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e,
	0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x12, 0x2e, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e,
	0x44, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_discount_proto_goTypes = []interface{}{
	(*Info)(nil),     // 0: discount.Info
	(*Discount)(nil), // 1: discount.Discount
}
var file_discount_proto_depIdxs = []int32{
	0, // 0: discount.DiscountService.CalculateDiscount:input_type -> discount.Info
	1, // 1: discount.DiscountService.CalculateDiscount:output_type -> discount.Discount
...
func (c *discountServiceClient) CalculateDiscount(ctx context.Context, in *Info, opts ...grpc.CallOption) (*Discount, error) {
	out := new(Discount)
	err := c.cc.Invoke(ctx, "/discount.DiscountService/CalculateDiscount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DiscountService_CalculateDiscount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/discount.DiscountService/CalculateDiscount",
	}
